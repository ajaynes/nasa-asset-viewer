...
export default function Card({ title, thumbnailUrl, keywords = [], mediaType, id }: CardProps) {
  ...
  return (
    <Link href={`/item/${id}`}>
      <article className="flex h-full flex-col overflow-hidden rounded-md border border-slate-200 bg-white shadow-md border-white hover:shadow-lg hover:shadow-gray-950 hover:border-blue-500">
